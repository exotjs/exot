import router, { HTTPMethod, HTTPVersion, Instance as RouterInstance } from 'npm:find-my-way@7.7.0';
import type { RouterInit, RouterFindResult, ContextInterface } from './types.ts';
import type { ChainFn } from './types.ts';
